...
export const Image = (props: IImageProps) => {
  ...
  return (
    <div>
      <h2 id="image-heading">
        <Translate contentKey="bankApp.image.home.title">Images</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="bankApp.image.home.createLabel">Create new Image</Translate>
        </Link>
      </h2>
        ...
        {imageList && imageList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bankApp.image.home.notFound">No Images found</Translate>
            </div>
          )
        )}
      </div>
