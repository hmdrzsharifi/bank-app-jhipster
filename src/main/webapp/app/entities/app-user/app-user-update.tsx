...
export const AppUserUpdate = (props: IAppUserUpdateProps) => {
  ...
  const { appUserEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bankApp.appUser.home.createOrEditLabel">
            <Translate contentKey="bankApp.appUser.home.createOrEditLabel">Create or edit a AppUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : appUserEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="fieldNameLabel" for="app-user-fieldName">
                  <Translate contentKey="bankApp.appUser.fieldName">Field Name</Translate>
                </Label>
                <AvField id="app-user-fieldName" type="text" name="fieldName" />
