  ...
  return (
    <div>
      <h2 id="app-user-heading">
        <Translate contentKey="bankApp.appUser.home.title">App Users</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="bankApp.appUser.home.createLabel">Create new App User</Translate>
        </Link>
      </h2>
        ...
        {appUserList && appUserList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bankApp.appUser.home.notFound">No App Users found</Translate>
            </div>
          )
        )}
      </div>
