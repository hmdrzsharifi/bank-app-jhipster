...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tetra.bank.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tetra.bank.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.tetra.bank.domain.User.class.getName());
            createCache(cm, com.tetra.bank.domain.Authority.class.getName());
